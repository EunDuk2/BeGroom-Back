...
public class AdminProductController {
    ...
    public ResponseEntity<CommonSuccessDto<Slice<ProductListResponse>>> getAllProducts(
        ...
        Slice<ProductListResponse> products = adminProductService.getAllProductsForAdmin(statuses, pageable);
