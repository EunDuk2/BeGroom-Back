...
//
//        // when
//        Slice<Product> result1 = productRepository.findAllByCondition(condition1, PageRequest.of(0, 10));
//        Slice<Product> result2 = productRepository.findAllByCondition(condition2, PageRequest.of(0, 10));
//        Slice<Product> result3 = productRepository.findAllByCondition(condition3, PageRequest.of(0, 10));
//        Slice<Product> result4 = productRepository.findAllByCondition(condition4, PageRequest.of(0, 10));
//
//        // then
...
//
//        Slice<Product> result = productRepository.findAllByCondition(condition, PageRequest.of(0, 10));
//
//        // then
