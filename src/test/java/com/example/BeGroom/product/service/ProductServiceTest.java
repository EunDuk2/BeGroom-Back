...
//
//        // when
//        Slice<ProductListResponse> result = productService.searchProducts(condition, PageRequest.of(0, 10), member.getId());
//
//        // then
...
//
//        // when
//        Slice<ProductListResponse> result = productService.searchProducts(condition, PageRequest.of(0, 10), null);
//
//        // then
//        assertThat(result.getContent()).hasSize(2);
...
//
//        // when
//        Slice<ProductListResponse> page1 = productService.searchProducts(condition, PageRequest.of(0, 10), null);
//        Slice<ProductListResponse> page2 = productService.searchProducts(condition, PageRequest.of(1, 10), null);
//        Slice<ProductListResponse> page3 = productService.searchProducts(condition, PageRequest.of(2, 10), null);
//
//        // then
